(function () {
  ...
  const apiBase = container.dataset.api || window.location.origin;
    ...
    try {
      ...
      if (testimonials.length === 0) {
        container.innerHTML = `
          <div class="ha-widget">
            ...
            <div class="ha-widget__powered">Powered by <a href="#">HighAdvocacy</a></div>
          </div>`;
        return;
      }
      ...
      const cards = testimonials.map(t => {
        ...
        const avatar = t.photo_url
          ? `<img src="${apiBase}${t.photo_url}" alt="${t.name}" class="ha-card__avatar" loading="lazy" />`
      ...
      container.innerHTML = '<div class="ha-widget"><div class="ha-widget__error">Unable to load testimonials.</div></div>';
    }
  }
